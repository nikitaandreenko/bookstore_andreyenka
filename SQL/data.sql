...
VALUES ('it starts us', 'Collen Hoover', '978-1668001226', 11.99, 366, 'solid', 2022,
       ...
       ('I train update books', 'Collen Hoover', '978-1533723738', 11.99, 326, 'solid', 2019,
        (SELECT id FROM languages WHERE name = 'RUSSIAN')),
       ...
       ('Ugly love', 'Collen Hooveer', '978-1476753188', 11.86, 437, 'soft', 2004,
        (SELECT id FROM languages WHERE name = 'SPANISH')),
       ...
       ('The Very Hungry Caterpillar', 'Eric Carle', '978-0399226908', 5.74, 26, 'soft', 2013,
        (SELECT id FROM languages WHERE name = 'CHINESE')),
       ...
       ('The Lord of the Rings Part One', 'J.R.R. Tolkien', '978-0063270886', 14.89, 432, 'solid', 2016,
        (SELECT id FROM languages WHERE name = 'RUSSIAN')),
       ('Fire & Blood: 300 Years Before A Game of Thrones', 'George R. R. Martin', '978-0063270835', 24.89, 754,
        'solid', 2014, (SELECT id FROM languages WHERE name = 'RUSSIAN')),
       ...
       ('Mastering the Art of French Cooking', 'Julia Child', '978-1238725736', 19.50, 1244, 'soft', 2015,
        (SELECT id FROM languages WHERE name = 'FRENCH')),
       ('A Letter From Your Teacher: On the First Day of School', 'Shannon Olsen', '978-1735414126', 13.99, 31, 'soft',
        2007, (SELECT id FROM languages WHERE name = 'ENGLISH'));
